...
base_data_dir = "D:/monai-project/Data_Train_Test"

input_volumes_dir = os.path.join(base_data_dir, "TestVolumes")
ground_truth_seg_dir = os.path.join(base_data_dir, "TestSegmentation")

totalseg_temp_output_dir = "D:/monai-project/totalseg_temp_output"
final_liver_masks_dir = "D:/monai-project/final_liver_masks"
output_slice_images_dir = "D:/monai-project/output_slice_images"
